...
export async function getServerSideProps({params}) {
  // Fetch data from external API    
    ...
    const [res1, res2, res3, res4] = await Promise.all([
      ...
      fetch(`https://financialmodelingprep.com/api/v3/balance-sheet-statement/${symbol}?apikey=fea107802693a9f21cc94def10b870da&limit=10`).then(response => response.json()),
