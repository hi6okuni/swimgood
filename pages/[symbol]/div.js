...
export async function getServerSideProps({params}) {
  // Fetch data from external API    
    ...
    const [res1, res2, res3, res4] = await Promise.all([
      fetch(`https://financialmodelingprep.com/api/v3/historical-price-full/stock_dividend/${symbol}?apikey=fea107802693a9f21cc94def10b870da`).then(response => response.json()),
