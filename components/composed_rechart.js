          ...
          return (
            <ResponsiveContainer width="90%" height="90%">
              ...
              >
                ...
                <Legend align="center" />
                <Bar
                  dataKey="otherNonCurrentAssetsR"
                  stackId="a"
                  fill={color.debit6}
                />
                <Bar
                  dataKey="propertyPlantEquipmentNetR"
                  stackId="a"
                  fill={color.debit5}
                />
                <Bar
                  dataKey="otherCurrentAssetsR"
                  stackId="a"
                  fill={color.debit4}
                />
                <Bar dataKey="inventoryR" stackId="a" fill={color.debit3} />
                <Bar
                  dataKey="netReceivablesR"
                  stackId="a"
                  fill={color.debit2}
                />
                <Bar
                  dataKey="cashAndCashEquivalentsR"
                  stackId="a"
                  fill={color.debit1}
                />
              </BarChart>
