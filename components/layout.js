  ...
  return (
    <Box bg="#f5f7ff" color="#3f3356" minH="100vh" minW="100%">
      <Head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;800&family=Pacifico&family=Noto+Sans+JP:wght@700&display=swap"
          rel="stylesheet"
        />
        <meta name="description" content="Visualize U.S Stock. INSTANTLY. " />
        <meta
          property="og:image"
