  ...
  return (
    <>
      ...
      >
        ...
        <Flex className="menu-btn" onClick={() => navSlide()}>
      ...
      {toggleMenuBar ? (
        <Flex
          ...
          opacity="0.95"
        >
          <Flex justify="center" mt="15%" mb="5%" px="10%">
            <Search key="search" getSymbol={getSymbol} />
          </Flex>
          <Flex justify="space-around" wrap="wrap" mx="5%" color="white">
            {menuTitles.map((e) => {
              return (
                <Center
          ...
          <Center my="3%" w="80%" borderBottom="2px" color="gray.400"></Center>

          <Flex justify="space-around" wrap="wrap" w="100%" color="white">
            <Center fontSize="calc(5px + 2vmin)" mx="5%" w="80%">
              {menu == "sp500" ? (
                <Center
                  w="80%"
                  borderRadius="lg"
      ...
      <Flex
        ...
        bg="white"
      >
        <Flex h="30%" direction="column" align="center" fontSize="md">
          <Box
            color="#6263fb"
            fontSize="2xl"
            fontFamily="Pacifico"
        ...
        >
          ...
          <Center fontSize="calc(5px + 1vmin)" w="100%">
            {menu == "sp500" ? (
              <Center
                w="80%"
                borderRadius="lg"
